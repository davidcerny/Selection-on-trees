      seqfile = sate_shorter_names_cleaned6.fasta * sequence data file name
      outfile = cmos-model-params * main result file
     treefile = unrooted_raxml_sate.tre * tree structure file name
