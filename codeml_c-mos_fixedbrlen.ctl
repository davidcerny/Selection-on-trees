      seqfile = sate_shorter_names.fasta-gb
     treefile = RAxML_bestTree.sate_tree_brlen_optimization
      outfile = amniote_c-mos
 ...
 RateAncestor = 1   * force the estimation of ancestral states
  ...
  fix_blength = 2   * branch lengths fixed to those of the RAxML tree
